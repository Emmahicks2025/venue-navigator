...
export const venueMetadata: Record<string, Omit<VenueData, 'id' | 'name'>> = {
  ...
  'Akron Stadium': { city: 'Guadalajara', state: 'Jalisco', country: 'Mexico', type: 'stadium', capacity: 49850 },
  ...
  'Arrowhead Stadium': { city: 'Kansas City', state: 'MO', country: 'USA', type: 'stadium', capacity: 76416 },
  'AT&T Stadium': { city: 'Arlington', state: 'TX', country: 'USA', type: 'stadium', capacity: 80000 },
  ...
  'BC Place Stadium': { city: 'Vancouver', state: 'BC', country: 'Canada', type: 'stadium', capacity: 54500 },
  ...
  'BMO Field': { city: 'Toronto', state: 'ON', country: 'Canada', type: 'stadium', capacity: 30000 },
  ...
  'Estadio Azteca': { city: 'Mexico City', state: 'CDMX', country: 'Mexico', type: 'stadium', capacity: 87523 },
